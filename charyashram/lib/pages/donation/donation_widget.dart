...
class _DonationWidgetState extends State<DonationWidget> {
  ...
  void initState() {
    ...
    _model.textFieldFamilyCodeTextController ??= TextEditingController();
    _model.textFieldFamilyCodeFocusNode ??= FocusNode();

    _model.textFieldIndividualAmountTextController ??= TextEditingController();
    _model.textFieldIndividualAmountFocusNode ??= FocusNode();
                                ...
                                children: [
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        child: FlutterFlowDropDown<String>(
                                          ...
                                          hintText: 'Central Temple Branch',
                                        ...
                                        children: [
                                          Expanded(
                                            child: Container(
                                              ...
                                              child: TextFormField(
                                                controller: _model
                                                    .textFieldFamilyCodeTextController,
                                                focusNode: _model
                                                    .textFieldFamilyCodeFocusNode,
                                                autofocus: false,
                                                obscureText: false,
                                                decoration: InputDecoration(
                                                  hintText: 'Family-001121',
                                          ...
                                          FlutterFlowIconButton(
                                            borderRadius: 8.0,
                                            buttonSize: 40.0,
                                            fillColor: const Color(0xFF2C5AA0),
                                            icon: Icon(
                                              Icons.search,
                                              color:
                                                  FlutterFlowTheme.of(context)
                                                    ...
                                                    children: [
                                                      ...
                                                      Container(
                                                        ...
                                                        child: Align(
                                                          ...
                                                          child: TextFormField(
                                                            controller: _model
                                                                .textFieldIndividualAmountTextController,
                                                            focusNode: _model
                                                                .textFieldIndividualAmountFocusNode,
                                                            autofocus: false,
                                                            obscureText: false,
                                                            decoration:
                                                                InputDecoration(
                                  ...
                                  FFButtonWidget(
                                    onPressed: () async {
                                      ...
                                      if ((_model.apiResultrof?.succeeded ??
                                          true)) {
                                        FFAppState().currentOrderId =
                                            CashFreePaymentsApiGroup
                                                .razorPayGetOrderCall
                                                .orderid(
                                          (_model.apiResultrof?.jsonBody ?? ''),
                                        )!;
                                        FFAppState().paymentUrl =
                                            CashFreePaymentsApiGroup
                                                .razorPayGetOrderCall
                                                .paymenturl(
                                          (_model.apiResultrof?.jsonBody ?? ''),
